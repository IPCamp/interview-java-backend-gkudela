...
execute_process(
  COMMAND "/usr/bin/git" show-ref "b4916"
  WORKING_DIRECTORY "/home/qdi/java/java-llama.cpp/build/_deps/llama.cpp-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/b4916")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "b4916")
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'https://github.com/ggerganov/llama.cpp.git'")
  endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/home/qdi/java/java-llama.cpp/build/_deps/llama.cpp-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/qdi/java/java-llama.cpp/build/_deps/llama.cpp-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
